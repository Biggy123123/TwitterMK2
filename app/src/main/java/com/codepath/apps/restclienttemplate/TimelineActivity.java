...
public class TimelineActivity extends menu {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.compose) {
            //Compose icons has been selected
                ...
                try {
                    ...
                    @Override
                        public void run() {
                            ...
                            //insert user first
                            List<User> usersFromNetwork = User.FromNetworkArray(tweetsFromNetwork);
